...
const ChatContainer = () => {
  ...
  useEffect(() => {
    if (messageEndRef.current && messages.length > 0 && isNearBottom) {
      messageEndRef.current.scrollIntoView({ behavior: "smooth" });
    }
  }, [messages, isNearBottom]);

  // Handle scroll events to show/hide scroll button and detect if user is near bottom
  ...
  return (
    <div className="flex-1 flex flex-col h-full">
      ...
      <div 
        ...
        className="flex-1 overflow-y-auto p-4 space-y-1 bg-gray-50 dark:bg-gray-900 custom-scrollbar will-change-scroll relative"
      ...
      >
        ...
        {showScrollButton && (
          <button
            ...
            className="fixed bottom-24 right-6 z-10 p-3 bg-blue-500 hover:bg-blue-600 text-white rounded-full shadow-lg transition-all duration-200 transform hover:scale-105 touch-target"
