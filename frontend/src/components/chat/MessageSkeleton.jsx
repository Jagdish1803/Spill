  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 space-y-6">
      {skeletonMessages.map((_, idx) => {
        const isOwn = idx % 2 === 0; // Alternate message side
        const bubbleWidth = [180, 200, 220, 240][idx % 4]; // Different bubble widths for realism
        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col space-y-2">
              ...
              {isOwn && (
                <div className="h-2 w-8 rounded bg-gray-300/50 dark:bg-gray-700/50 animate-pulse" />
              )}
            </div>
          </div>
        );
